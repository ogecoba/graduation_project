...
public class CategoryHome extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabHost.TabSpec tabSpec = tabHost.newTabSpec("addCategory");
        tabSpec.setContent(R.id.tabAddCategory);
        tabSpec.setIndicator("Add Category");
        tabHost.addTab(tabSpec);


        // Tab For List Category
        tabSpec = tabHost.newTabSpec("listCategory");
        tabSpec.setContent(R.id.tabListCategory);
        tabSpec.setIndicator("List Category");
        tabHost.addTab(tabSpec);

        // Tab For Delete Category
        tabSpec = tabHost.newTabSpec("delCategory");
        tabSpec.setContent(R.id.tabDeleteCategory);
        tabSpec.setIndicator("Delete Category");
        tabHost.addTab(tabSpec);
    ...
    class CreateCourseCategory extends AsyncTask<String, String, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(CategoryHome.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Toast.makeText(CategoryHome.this, "Error Checking the response", Toast.LENGTH_LONG).show();
                }
                //  }

            } catch (JSONException e) {
                e.printStackTrace();
                Toast.makeText(CategoryHome.this,"An Exception Occur ...", Toast.LENGTH_LONG).show();
                Log.d("",file_url);
            }
